      ...
      <b-tabs card>
        <b-tab title="Experience">
          ...
          <vue-input-table
            ...
            :classmodal="experienceWorkDescriptionValue"
            :addbutton="false"
            :textarea="true"
            :removable="false"
          />
          ...
          <vue-input-table
            ...
            :classmodal="experienceWorkActivitiesValue"
...
export default {
  ...
  computed: {
    ...
    experienceWorkActivitiesValue: function () {
      return ExperienceWorkActivities;
    },
  },
  methods: {
    getExpId() {
